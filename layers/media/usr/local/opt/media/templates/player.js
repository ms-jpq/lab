...
/** @typedef {{position: number, start: number}} RetryChange */
...
/** @param {AbortSignal} signal @param {Mse} buffer @param {number} time @returns {AsyncGenerator<void, SessionFailure | void, void>} */
